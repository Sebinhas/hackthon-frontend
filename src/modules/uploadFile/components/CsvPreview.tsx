...
import { useObtenerPreviewArchivo } from '../hooks/useUploadFile';

interface CsvPreviewProps {
  fileId: string;
}

export const CsvPreview = ({ fileId }: CsvPreviewProps) => {
  const { data, isLoading } = useObtenerPreviewArchivo(fileId);
